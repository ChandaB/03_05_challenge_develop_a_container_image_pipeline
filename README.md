...
You’ve just joined a team that’s developing an API for mobile applications and they’re using containers for the first time and need to set up a CI/CD pipeline to publish container images.
